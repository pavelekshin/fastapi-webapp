...
from src.models.schema import HomePageView, ViewModelBase
...
async def index(
    ...
    stats = await aggr_service.get_count_statistics()
    home_page_view = HomePageView(user_id=user_id, **stats)
