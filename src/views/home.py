...
from src.models.schema import HomePageView, ViewModelBase, Package
...
async def index(
    ...
    home_page_view.packages = [Package(**p) for p in await package_service.latest_packages(limit=7)]
